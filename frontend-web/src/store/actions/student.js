  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .post(`${SERVER}/student/fetch`, formData, {
            // params: params,
            headers: headers
          })
          .then(res => {
...
export const uploadEmployeeFile = (file, callback) => {
  ...
  return dispatch=>{
    ...
    .then(res => {
      ...
      axios
        .post(`${SERVER}/student/upload/file`, formData, {
          // params: params,
          headers: headers
        })
        .then(res => {
  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .post(`${SERVER}/student/download/template`, formData, {
            // params: params,
            headers: headers,
            responseType: 'blob'
          })
  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .get(`${SERVER}/student/fetch/detail`, {
            params: params,
            headers: headers
          })
          .then(res => {
...
//         axios
//           .get(`${SERVER}/student/fetch/detailbycom`, {
//             params: params,
//             headers: headers
//           })
//           .then(res => {
...
export const fetchEmployeeDetailByCom = (EmpCode, CompanyCode, callback) => {  
  const headers = {
    "Content-Type": "multipart/form-data",
    Authorization: localStorage.getItem("jwtToken"),
    fingerprint: "123456",
...
export const fetchSchedule = (callback) => {  
  ...
  return dispatch => {
    axios
      .get(`${SERVER}/role/schedule/fetch`, {
        params,
        headers: headers
      })
      .then(res => {
...
export const insertSchedule = (EmpCode, DepartmentCode, OfficeCode, callback) => {
  const headers = {
    "Content-Type": "multipart/form-data",
    Authorization: localStorage.getItem("jwtToken"),
    fingerprint: "123456",
  ...
  formData.append('company_code', company_code);
  formData.append('office_code', OfficeCode);
  formData.append('dept_list_code', dept_list_code);
  formData.append('office_list_code', office_list_code);
  formData.append('is_hr', is_hr)
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/role/schedule/insert`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const deleteSchedule = (EmpCode, DepartmentCode, OfficeCode, callback) => {
  const headers = {
    "Content-Type": "multipart/form-data",
    Authorization: localStorage.getItem("jwtToken"),
    fingerprint: "123456",
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/role/schedule/delete`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const insertEmployee = (base64Data, params, callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/student/insert`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const updateEmployee = (base64Data, params, callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/student/update`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const deleteEmployee = (EmpCode, callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/student/delete`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const updateEmployeeApprove = (
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/student/update/approve`, formData, {
        //params: params,
        headers: headers
      })
      .then(res => {
...
export const updateEmployeeAvatar = (path, params,callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/student/register/avatar`, formData, {
        //params: params,
        headers: headers
      })
      .then(res => {
...
export const updateEmployeeUnapprove = (
  ...
  return dispatch => {
    axios
      .get(`${SERVER}/student/update/unapprove`, {
        params: params,
        headers: headers
      })
      .then(res => {
