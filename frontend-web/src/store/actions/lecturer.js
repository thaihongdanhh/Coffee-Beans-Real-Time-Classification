  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .post(`${SERVER}/lecturer/fetch`, formData, {
            // params: params,
            headers: headers
          })
          .then(res => {
...
export const uploadEmployeeFile = (file, callback) => {
  ...
  return dispatch=>{
    ...
    .then(res => {
      ...
      axios
        .post(`${SERVER}/lecturer/upload/file`, formData, {
          // params: params,
          headers: headers
        })
        .then(res => {
  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .post(`${SERVER}/lecturer/download/template`, formData, {
            // params: params,
            headers: headers,
            responseType: 'blob'
          })
  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .get(`${SERVER}/lecturer/fetch/detail`, {
            params: params,
            headers: headers
          })
          .then(res => {
  ...
  return dispatch => {
    ...
    axios.get("https://api.bigdatacloud.net/data/client-info")
      .then(res => {
        ...
        axios
          .get(`${SERVER}/lecturer/fetch/detailbycom`, {
            params: params,
            headers: headers
          })
          .then(res => {
...
export const insertEmployee = (base64Data, params, callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/lecturer/insert`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const updateEmployee = (base64Data, params, callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/lecturer/update`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const deleteEmployee = (EmpCode, callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/lecturer/delete`, formData, {
        headers: headers
      })
      .then(res => {
        // res.data.sizePerPage = sizePerPage
...
export const updateEmployeeApprove = (
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/lecturer/update/approve`, formData, {
        //params: params,
        headers: headers
      })
      .then(res => {
...
export const updateEmployeeAvatar = (path, params,callback) => {
  ...
  return dispatch => {
    axios
      .post(`${SERVER}/lecturer/register/avatar`, formData, {
        //params: params,
        headers: headers
      })
      .then(res => {
...
export const updateEmployeeUnapprove = (
  ...
  return dispatch => {
    axios
      .get(`${SERVER}/lecturer/update/unapprove`, {
        params: params,
        headers: headers
      })
      .then(res => {
